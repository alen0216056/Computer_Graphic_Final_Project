...
const double * parameter::get_center_position(const int index)
{
	return (0 <= index && index < center_num) ? center_pos[index] : center_pos[0];
}

const double * parameter::set_center_position(const int index, const double value[])
{
...
const double parameter::get_radius(const int index)
{
	return (0 <= index && index < center_num) ? radius[index] : radius[0];
}

const double parameter::set_radius(const int index, const double value)
{
	if (0 <= index && index < center_num)
	{
		radius[index] = value;
